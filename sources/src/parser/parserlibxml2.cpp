...
namespace citygml
{
    CityModel* load( std::istream& stream, const ParserParams& params, citygml::CityGMLLogger* logger )
    {
    ...
    CityModel* load( const std::string& fname, const ParserParams& params, citygml::CityGMLLogger* logger )
    {
        CityGMLHandlerLibXml2* handler = new CityGMLHandlerLibXml2( params );
