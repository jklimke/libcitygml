...
namespace citygml {
    ...
    bool RectifiedGridCoverage::Parser::handlesElement(const NodeType::XMLNode& node) const
    {
        return node == NodeType::GML_RectifiedGridCoverageNode;
    }

    std::string RectifiedGridCoverage::Parser::elementParserName() const
    {
        return "RectifiedGridCoverage::Parser";
    }

    bool RectifiedGridCoverage::Parser::parseElementStartTag(const NodeType::XMLNode& node, Attributes& attributes)
    {
    ...
    bool RectifiedGridCoverage::Parser::parseElementEndTag(const NodeType::XMLNode& node, const std::string&)
    {
        if (node != NodeType::GML_RectifiedGridCoverageNode) {
    ...
    bool RectifiedGridCoverage::Parser::parseChildElementStartTag(const NodeType::XMLNode& node, Attributes& attributes)
    {
        if (m_model == nullptr) {
    ...
    bool RectifiedGridCoverage::Parser::parseChildElementEndTag(const NodeType::XMLNode& node, const std::string& characters)
    {
    ...
    FeatureObject* RectifiedGridCoverage::Parser::getFeatureObject()
    {
        return m_model;
    }
